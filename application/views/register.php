...
<head>
  ...
  <link href="<?php echo base_url();?>css/jquery.mb.YTPlayer.min.css" media="all" rel="stylesheet" type="text/css">
...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="site-wrap">
          ...
          <div class="mr-auto">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                <li>
                  <a href='<?php echo base_url()."index.php/Welcome/load_index"?>' class="nav-link text-left">Home</a>
                </li>
    ...
    <div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('<?php echo base_url();?>images/bg_1.jpg')">
        <div class="container">
                ...
                <div class="col-md-5">
                    <div class="row">
                       <div class="col-md-12 form-group">
                            ...
                            <input type="text" id="username" class="form-control form-control-lg" name="name" required>
                        </div>
                        <div class="col-md-12 form-group">
                        ...
                        <div class="col-md-12 form-group">
                            <label for="pword">Mobile</label>
                            <input type="text" id="pword" class="form-control form-control-lg" name="mobile" required>
                        </div>
                        <div class="col-md-12 form-group">
                            <label for="sel1" >Designation</label>
                              <select class="form-control" id="sel1" name="designation">
                                ...
                                <option value="quality_tester">Quality Tester</option>
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <input type="password" id="pword" class="form-control form-control-lg" name="password" required>
                        </div>
                        <div class="col-md-12 form-group">
                            <label for="pword2">Re-type Password</label>
                            <input type="password" id="pword2" class="form-control form-control-lg"  required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
