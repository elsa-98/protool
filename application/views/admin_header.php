                ...
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        <li class="active has-sub">
                            <a class="js-arrow" href='<?php echo base_url()."index.php/admin_controll/load_home"?>'>
                        ...
                        <li class="has-sub">
                            ...
                            <li>
                                    <a href='<?php echo base_url()."index.php/admin_controll/load_new_proj"?>'>Assign New Projects</a>
                                </li>
                                <li>
                                    <a href='<?php echo base_url()."index.php/admin_controll/load_assigned_proj"?>'>Active Projects</a>
                                </li>
                                <li>
                                    <a href='<?php echo base_url()."index.php/admin_controll/load_compl_proj"?>'>Completed</a>
                                </li>
                                <li>
                                    <a href='<?php echo base_url()."index.php/admin_controll/load_pending_proj"?>'>Pending</a>
                                </li>
                            </ul>
                        </li>
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-chart-bar"></i>Project Teams</a>
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                            <li>
                                    <a href='<?php echo base_url()."index.php/admin_controll/load_view_team"?>'>View Teams</a>
                                </li>
                                <li>
                                    <a href='<?php echo base_url()."index.php/admin_controll/load_new_team"?>'>Create New Team</a>
                                </li>
                        ...
                        <li>
                            <a href='<?php echo base_url()."index.php/admin_controll/load_employees"?>'>
                                ...
                                <div class="noti-wrap">
                                    ...
                                    <div class="noti__item js-item-menu">
                                        ...
                                        <div class="email-dropdown js-dropdown">
                                            ...
                                            <div class="email__item">
                                                <div class="<?php echo base_url();?>image img-cir img-40">
                                    ...
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            ...
                                            <div class="account-dropdown__footer">
                                                <a href='<?php echo base_url()."index.php/admin_controll/logout"?>'>
