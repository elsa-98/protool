    ...
    <div class="site-section">
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-md-5">
                    <div class="row">
                    <form name="submit"  action='<?php echo base_url()."index.php/Welcome/authenticate"?>' method="post">
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <input type="text" id="pword" name="password" class="form-control form-control-lg" required>
                            
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <input type="submit" value="LOGIN" name="submit" class="btn btn-primary btn-lg px-5">
                        </div>
                    </div>
                    </form>
                </div>
